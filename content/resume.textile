...
Passionate and engaging developer that likes to explore new languages, techniques and methodologies to constantly improves myself. Pragmatic approach to learning vs using. Thrives in an environment where I can interact with existing people and create cool things.


h2. Selected Technical kills

Scala, Java, PHP, Bash, SQL, Javascript, UML, AJAX, Spring, Maven, Jetty, Lift, Zend Framework, Doctrine, Git, Linux, Mac, Win32, XML, HTML, CSS
...
My vonlunteer work are ether related to my hobby as a roleplaying/boardgamer or to organizing groups for computer professionals/students. 
