...
Passionate and engaging developer that like to explore new languages, techniques and methodologies to constantly improve myself. Pragmatic approach to learning vs using. Thrives in an environment where I can interact with existing people and give the customer value.
...
* imageproxy -> convert images to correct screen width easily
...
* smslist -> mailing list with SMS as transport for Team Expert
* location-based raw material balancing. You have 10 units of resource A that I need, and I am close to you. 
