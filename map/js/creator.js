    ...
    $(".tiles").click(function(e) {
        $(".tiles").unbind("mousemove");
				$(".ui-selected").each(function() {
					...
					var t = this.map.tile($(that).attr("id"));

						if(t.tile == previewTile){
								return this;
						}
